# Adapoted from PyTorch Geometric, since I can't get this module in my PyG install for some reason
# Changes:
# - remove InputNodes typing from torch_geometric.typing
# - copy `get_input_node_type` here
# Source: https://github.com/pyg-team/pytorch_geometric/blob/master/torch_geometric/data/lightning_datamodule.py
...
class LightningNodeData(LightningDataModule):
    ...
    def __init__(
        ...
        input_train_nodes = None,
        input_val_nodes = None,
        input_test_nodes = None,
        loader: str = "neighbor",
        batch_size: int = 1,
        num_workers: int = 0,
        **kwargs,
    ...
    def dataloader(self, input_nodes) -> DataLoader:
        if self.loader == 'full':
